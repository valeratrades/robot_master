...
graph TD
    ...
    subgraph base.cv::robot_master_train_boundary["**Robot Master Training Service**<br>[External]"]
        base.cv::training_orchestrator["**Training Orchestrator**<br>/home/v/s/other/robot_master/py_src/train.py `if __name__ == "__main__":`"]
        ...
        base.cv::cnn_model["**CNN Model**<br>/home/v/s/other/robot_master/py_src/model_resnet.py `class RobotMasterResNet:`"]
        base.cv::transformer_model["**Transformer Model**<br>/home/v/s/other/robot_master/py_src/model_transformer.py `class RobotMasterTransformer:`"]
        base.cv::model_exporter["**Model Exporter**<br>/home/v/s/other/robot_master/py_src/export_onnx.py `main()`"]
        ...
        base.cv::training_orchestrator["**Training Orchestrator**<br>/home/v/s/other/robot_master/py_src/train.py `if __name__ == "__main__":`"] -->|"Trains"| base.cv::cnn_model["**CNN Model**<br>/home/v/s/other/robot_master/py_src/model_resnet.py `class RobotMasterResNet:`"]
        base.cv::training_orchestrator["**Training Orchestrator**<br>/home/v/s/other/robot_master/py_src/train.py `if __name__ == "__main__":`"] -->|"Trains"| base.cv::transformer_model["**Transformer Model**<br>/home/v/s/other/robot_master/py_src/model_transformer.py `class RobotMasterTransformer:`"]
        base.cv::training_orchestrator["**Training Orchestrator**<br>/home/v/s/other/robot_master/py_src/train.py `if __name__ == "__main__":`"] -->|"Sends trained model to"| base.cv::model_exporter["**Model Exporter**<br>/home/v/s/other/robot_master/py_src/export_onnx.py `main()`"]
    end
    %% Edges at this level (grouped by source)
    ...
    base.cv::model_exporter["**Model Exporter**<br>/home/v/s/other/robot_master/py_src/export_onnx.py `main()`"] -->|"Generates compatible ONNX model for"| base.cv::onnx_runtime["**ONNX Runtime**<br>/home/v/s/other/robot_master/Cargo.toml `ort = "=2.0.0-rc.12"`, /home/v/s/other/robot_master/robot_master_train/Cargo.toml `ort = { workspace = true, features = ["cuda"] }`"]
